...
mod tests {
    ...
    #[test]
    fn first_example() {
        test_on_input(DAY, Puzzle::First, InputType::Example(0), 35);
    }

    #[test]
    fn first_input() {
        test_on_input(DAY, Puzzle::First, InputType::PuzzleInput, 265_018_614);
    }

    #[test]
    fn second_example() {
        test_on_input(DAY, Puzzle::Second, InputType::Example(0), 46);
    }

    #[test]
    fn second_input() {
        test_on_input(DAY, Puzzle::Second, InputType::PuzzleInput, 63_179_500);
    }
}
