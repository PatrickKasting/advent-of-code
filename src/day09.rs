...
mod tests {
    ...
    #[test]
    fn first_examples() {
        test_on_input(DAY, Puzzle::First, InputType::Example(0), 114);
    }
    ...
    #[test]
    fn second_example() {
        test_on_input(DAY, Puzzle::Second, InputType::Example(0), 2);
    }

    #[test]
    fn second_input() {
        test_on_input(DAY, Puzzle::Second, InputType::PuzzleInput, 988);
    }
}
